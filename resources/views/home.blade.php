            ...
            <div>
                <div class="panel p-3 lg:p-6 lg:pb-3 rounded-1-5 lg:rounded-2 bg-secondary dark:bg-gray-800 overflow-hidden">
                    <div class="heading vstack items-center gap-2 panel max-w-550px mx-auto text-center" data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: easeOutCubic; duration: 500; delay: anime.stagger(100, {start: 200});">
                        ...
                        <h2 class="title h3 lg:h2 xl:h1 m-0 px-2">Unique <span class="d-inline-flex px-1 bg-primary text-secondary -rotate-1 lg:-rotate-2 rounded-1 lg:rounded-1-5">videos</span> each time.</h2>
                        ...
                        <div class="swiper-wrapper ease-linear">
                                ...
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-1.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-2.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-3.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-4.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-5.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-6.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-7.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="item-preview panel p-1">
                                    <div class="panel bg-white border border-secondary-600 rounded-1 shadow-xs hover:shadow-md transition-all duration-250 hover:-translate-y-1 overflow-hidden">
                                        <div class="panel overflow-hidden">
                                            <video src="{{ asset('assets/videos/short-9.mp4') }}" playsinline autoplay loop muted></video>
                                        </div>
                                    </div>
                                </div>
                            </div>
