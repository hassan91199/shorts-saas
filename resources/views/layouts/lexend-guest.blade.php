...
<body class="uni-body panel bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100 overflow-x-hidden">
    ...
    <!-- Header start -->
    @if ($showHeader)
        <header class="uc-header header-six uc-navbar-sticky-wrap z-999"
            ...
            <nav class="uc-navbar-container lg:mt-3 rounded-0 lg:rounded-pill uc-navbar-float ft-tertiary z-1"
                                ...
                                @if (Route::has('login'))
                                    @auth
                                        <a href="{{ route('series.index') }}"
                                            class="btn btn-sm btn-primary px-3 d-none lg:d-inline-flex"><span>Dashboard</span></a>
                                    @else
                                        <a href="{{ route('login') }}"
                                            class="fs-5 fw-medium text-none d-none lg:d-inline-flex"><span>Sign
                                                In</span></a>
                                        @if (Route::has('register'))
                                            <a href="{{ route('register') }}"
                                                class="btn btn-sm btn-primary px-3 d-none lg:d-inline-flex"><span>Register</span></a>
                                        @endif
                                    @endauth
                                @endif
                    ...
                    <div class="container xl:max-w-xl">
                        <div class="uc-footer-inner vstack gap-4 lg:gap-6 xl:gap-8">
                                        ...
                                        <div class="panel vstack items-start gap-3 xl:gap-4 lg:max-w-1/2">
                                            <div>
                                                ...
                                                <p class="mt-2">{{ config('app.name') }} automatically creates,
                                                    schedules, and posts Faceless videos for you, on auto-pilot. Each
                                                    video is unique and customized to your topic.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div
                                ...
                                <p class="opacity-60">{{ config('app.name') }} © {{ date('Y') }}, All rights
                                    reserved.</p>
