                                ...
                                <div class="position-cover text-white vstack justify-end p-4 lg:p-6 xl:py-8">
                                    ...
                                    <div class="panel z-1">
                                        <div class="vstack gap-3"
                                            ...
                                            <p class="fs-5 xl:fs-4 fw-medium">“{{ config('app.name') }} makes creating
                                                high-quality, faceless shorts easy with AI tools. It's like having a
                                                professional editor at my fingertips. Highly recommended!”</p>
